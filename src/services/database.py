...
from src.models.models import Validator, Base, Delegator, GovernanceProposal  # Adjust the import path as necessary
...
# Assuming your SQLAlchemy engine setup is defined elsewhere or earlier in the file
# For example, using SQLite for demonstration
engine = create_engine('sqlite:///chainsight.db')
Session = sessionmaker(bind=engine)
Base.metadata.create_all(engine)


def insert_validator(validator_data):
    session = Session()
    try:
